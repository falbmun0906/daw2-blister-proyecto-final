...
export const CIMA_REGISTRO_CAMBIOS_NOTIFICATION_FIELDS = [
  'estado',
  'comerc',
  'prosp',
  'ft',
...
export const DOSE_REMINDER_SCAN_LOOKBACK_MS = 45 * 60 * 1000;
export const PUSH_NOTIFICATION_TTL_SECONDS = 24 * 60 * 60;
export const PUSH_NOTIFICATION_URGENCY = 'high' as const;
